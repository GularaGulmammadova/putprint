    ...
    return (
        <div  className={styles.column}>
          ...
          <div className={chosen==='Yazı' ? styles.choiceText : styles.none}>
            ...
            <h3 className={styles.title}>Şrift ölç seçin</h3>
            <input defaultValue={content.label.fontSize} onChange={(e) => setContent({...content, label: {...content.label, fontSize: Number(e.target.value)}})} min={10} max={100} className={styles.input} type='number' placeholder='10' />
