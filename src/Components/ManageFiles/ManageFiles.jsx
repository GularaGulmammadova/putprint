  ...
  return (
    <div className={styles.file}>
      ...
      <div className={styles.picker}>
        ...
        {(product.name!=='Kepka' && product.name!=='Eko Çanta') && <><h3 className={styles.title}>Ölçü</h3>   
        <div className={styles.btns}>
        ...
        {(product.name === "Sviter" || product.name === "Kapşonlu Sviter") && <><h3 className={styles.title}>Material</h3>   
        <div className={styles.btns}>
